...
export default function UserProfile() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        <div className="group-hover:bg-token-interactive-bg-secondary-selected touch:h-10 touch:w-10 flex h-9 w-9 items-center justify-center rounded-full group-focus-visible:ring-2">
        ...
        >
          ...
          >
            <div className="flex flex-col">
              {/* 用户信息 */}
              <div className="flex items-center gap-1.5 px-3 py-2 text-gray-600 dark:text-gray-300">
              ...
              <div
                role="menuitem"
                className="flex items-center gap-1.5 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer transition-colors"
              ...
              <div
                role="menuitem"
                className="flex items-center justify-between px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer transition-colors"
                onClick={() => setIsOpen(false)}
              >
